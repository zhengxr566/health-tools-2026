...
def steps():
    ...
    meta = meta_for(
        ...
        "10000步通常可消耗约250–500卡路里（取决于体重和步速）。例如50kg体重大约消耗400kcal。输入步数和体重，快速估算步行热量消耗，适合日常活动与减脂参考。",
        "/steps",
    )
    return render_template(
        "steps.html",
...
def steps_distance():
    ...
    meta = {
        ...
        "description": "10000步一般约为6–8公里。输入步数、身高和性别，即可根据步幅估算步行距离。简化模型：男性步幅≈身高×0.415，女性步幅≈身高×0.413。",
